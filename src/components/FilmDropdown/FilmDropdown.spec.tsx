...
describe("FilmsDropdown component", () => {
  it("should render films information correctly", () => {
    render(<FilmDropdown film={mockedFilm} />);

    expect(screen.getByText("A New Hope")).toBeInTheDocument();
    expect(screen.getByText("Episode 4 - 1977")).toBeInTheDocument();
  });

  it("should display film details when dropdown is clicked", () => {
    render(<FilmDropdown film={mockedFilm} />);

    const dropdownElement = screen.getByText("A New Hope");
